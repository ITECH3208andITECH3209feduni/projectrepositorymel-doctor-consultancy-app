...
<div class="w3-main" style="margin-left:250px">
 ...
 <p><a href="doctorsignin.php"class=" w3-white w3-left">Click Here if you are a doctor to signin</a></p>
 ...
 <!-- Image header -->
  ...
  <div class="w3-container w3-black w3-padding-32">
    <h1>Register</h1>
    <p>To get instant Appointment</p>
	<a href="register.php" class="w3-button w3-red w3-margin-bottom">Register</a>	
	</div>
  <div class=" " id= "body"> 
  
	<img src="doctors.jpg" alt="doctor for home page" width ="100%" height="600">
  </div>
  <!-- Footer -->
