...
<div class="w3-main" style="margin-left:250px">
  ...
  <form action="" method="POST" id = "loginForm">
			...
			if(isset($_POST['email'])){
				...
				$query = "SELECT username,email,password FROM doctor WHERE email = '$email'";
    ...
    <p>Please fill your details.</p>
	 <p><input class="w3-input w3-border" name ="email" type="text" placeholder="Email" style="width:50%"></p>
	 <p><input class="w3-input w3-border" name= "password" type="password" placeholder="Password" style="width:50%"></p>
	<button class="w3-button w3-red w3-margin-bottom">Signin</button>
	</form>  
  </div>
  <div class=" " id= "body"> 
