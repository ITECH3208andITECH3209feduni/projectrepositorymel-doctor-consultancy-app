...
<div class="w3-main" style="margin-left:250px">
  ...
  <p class="w3-right">
  <h1>Know and get yout Medicine</h1>
  <h5>Select and get your medicine</h5>
	</div>
	<!-- Medicine Section -->
  <div class=" " id= "body"> 
   <div class="w3-row-padding w3-grayscale">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="skincare.png" alt="skincare" style="width:100%">
      <h3>Skin care</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="pain.jpeg" alt="pain" style="width:100%">
      <h3>Pain</h3>
     <p><button class="w3-button w3-light-grey w3-block">Buy</button></p>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="dental.jpg" alt="Dan" style="width:100%">
      <h3>Family dental</h3>
      <p><button class="w3-button w3-light-grey w3-block">Buy</button></p>
    </div>
  </div>
