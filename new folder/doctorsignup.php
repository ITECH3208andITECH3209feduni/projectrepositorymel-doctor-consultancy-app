...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a href="index.php" class="w3-bar-item w3-button">Doctors</a>
...
<a href="Signin.php" class="w3-button w3-blue w3-right">Sign in</a>
  ...
  <div class="w3-container w3-black w3-padding-32">
    ...
    <p>Please fill your details.</p>
	 ...
	 <p><input class="w3-input w3-border" type="text" placeholder="Name" style="width:50%"></p>
	 <p><input class="w3-input w3-border" type="text" placeholder="Number" style="width:50%"></p>
	 <p><input class="w3-input w3-border" type="text" placeholder="Email" style="width:50%"></p>
     <p><input class="w3-input w3-border" type="text" placeholder="Address" style="width:50%"></p>
	
	<button type="button" class="w3-button w3-red w3-margin-bottom">Register</button>
  </div>
  <div class=" " id= "body"> 
